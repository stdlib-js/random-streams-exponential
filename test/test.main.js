...
tape( 'the constructor returns a stream for generating pseudorandom numbers from an exponential distribution', function test( t ) {
	var iStream;
	var result;
	var rand;
	var opts;
...
tape( 'the constructor returns a stream for generating pseudorandom numbers from an exponential distribution (object mode)', function test( t ) {
	var iStream;
	var count;
	var rand;
	var opts;
