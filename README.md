...
> Create a [readable stream][readable-stream] for generating pseudorandom numbers drawn from an [exponential][exponential] distribution.
...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-exponential@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-exponential/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-exponential@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-exponential/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-exponential@umd/browser.js"></script>
```
...
Returns a [readable stream][readable-stream] for generating pseudorandom numbers drawn from an [exponential][exponential] distribution with rate parameter `lambda`.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-exponential.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-exponential

[test-image]: https://github.com/stdlib-js/random-streams-exponential/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-streams-exponential/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-streams-exponential/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-streams-exponential?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-exponential.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-streams-exponential/main
...
[cli-section]: https://github.com/stdlib-js/random-streams-exponential#cli
[cli-url]: https://github.com/stdlib-js/random-streams-exponential/tree/cli
[@stdlib/random-streams-exponential]: https://github.com/stdlib-js/random-streams-exponential/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/random-streams-exponential/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-streams-exponential/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-exponential/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-exponential/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-exponential/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-exponential/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-streams-exponential/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-streams-exponential/main/LICENSE
