...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from an exponential distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating exponential distributed pseudorandom numbers.
	*/
